...
const TextAreaBlock = ({ defaultSide,fontSize=20, editable = true, font, setParentFrontText: setFrontText, frontText, setParentBackText: setBackText, backText, setSideBlock, showButtons = false }) => {
    ...
    return (
        <View>
            {showButtons && (
                <View style={{
                    flexDirection: 'row',
                    marginBottom: 10, alignItems: 'flex-end', justifyContent: 'flex-end', paddingHorizontal: 40
                }}>
...
const StampArea = ({ viewStamps, stampImage, showText = true }) => {
    ...
    return (
        <View style={{ borderColor: '#654321', borderWidth: 1, height: 100, width: 100, padding: 20, justifyContent: 'center', alignItems: 'center', }}>
...
const HeaderArea = () => {
    return (
        <View style={{ alignSelf: 'center' }}>
            <Text style={{ fontSize: 32, fontFamily: 'Curiousness', borderBottomWidth: 2, borderColor: '#654321' }}>POST-CARD</Text>
    ...
    return (
        <View style={{ borderWidth: 1, borderColor: '#654321', margin: 5 }}>
            <ImageBackground source={item.url} imageStyle={{ resizeMode: 'cover' }} style={{ width: 220, height: 120, alignItems: 'center', justifyContent: 'center' }}>
                <Text style={{ fontSize: 20, fontFamily: 'Curiousness', }}>{item.name}</Text>
            </ImageBackground>
        </View>
    )
}
...
export default HomeScreen = () => {
    ...
    const PrintPreview = () => {
        ...
        return (
            <View style={{ backgroundColor: '#fff', height: '100%', paddingTop: 40, }}>
                ...
                <View style={{ marginTop: 20, backgroundColor: 'rgba(255, 255, 255, 0.3)', color: '#fff', flexDirection: 'row', height: 40, padding: 5, justifyContent: 'space-between' }}>

                    <View style={{ flex: 1, alignSelf: 'flex-start', flexDirection: 'row', }}>
                        <TouchableOpacity onPress={rotateFonts}>
                            <MaterialCommunityIcons name="format-text" size={32} ></MaterialCommunityIcons>
                        </TouchableOpacity>
                        <TouchableOpacity style={{marginLeft: 5}} onPress={showBackgrounds}>
                            <MaterialCommunityIcons name="format-color-fill" size={38} ></MaterialCommunityIcons>
                        </TouchableOpacity>
                        <TouchableOpacity style={{marginLeft: 5}} onPress={() => setFontSize(fontSize-1)}>
                            <MaterialCommunityIcons name="format-font-size-decrease" size={32} ></MaterialCommunityIcons>
                        </TouchableOpacity>
                        <TouchableOpacity style={{marginLeft: 5}} onPress={() => setFontSize(fontSize+1)}>
                            <MaterialCommunityIcons name="format-font-size-increase" size={32} ></MaterialCommunityIcons>
                        </TouchableOpacity>
                    </View>
                    <TouchableOpacity onPress={() => setShowPreview(false)} style={{ borderRadius: 20, alignSelf: 'flex-end', marginRight: 8, alignItems: 'center', justifyContent: 'center', textAlign: 'center', paddingVertical: 5, borderWidth: 1, borderColor: '#654321', width: 100 }}>
                        <Text style={{ fontFamily: 'Curiousness', }}>Back</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={snapshot} style={{ borderRadius: 20, alignSelf: 'flex-end', alignItems: 'center', justifyContent: 'center', textAlign: 'center', paddingVertical: 5, borderWidth: 1, borderColor: '#654321', width: 100 }}>
    ...
    return (
        ...
        <ImageBackground ref={printRef} source={backgrounds[backgroundCount]} imageStyle={{ resizeMode: 'cover' }} style={{ width: '100%', height: '100%', }}>
            <View collapsable={false} style={{ paddingTop: 40, flex: 1 }}>
                {showHeader && (
            ...
            <View style={{ backgroundColor: 'rgba(255, 255, 255, 0.3)', color: '#fff', flexDirection: 'row', height: 40, padding: 5, justifyContent: 'space-between' }}>
                ...
                <TouchableOpacity onPress={preview} style={{ borderRadius: 20, alignSelf: 'flex-end', alignItems: 'center', justifyContent: 'center', textAlign: 'center', paddingVertical: 5, borderWidth: 1, borderColor: '#654321', width: 100 }}>
